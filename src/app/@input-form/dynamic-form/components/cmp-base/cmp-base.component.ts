...
import { Data } from '../cmp-onebox/data';

@Component({
  selector: 'esf-cmp-base',
  templateUrl: './cmp-base.component.html',
  styleUrls: ['./cmp-base.component.css']
})
/**
 * Add common behavior to dynamic components
 */
export class CmpBaseComponent implements OnInit {
